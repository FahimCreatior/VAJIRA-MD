...
global.owner = process.env.OWNER_NUMBER  || '254797992027' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=SYNBmRgS#_-gaqfJe7HZlyIXOwml9jn5uByppmqGYu0kvN44uHhs' ,
